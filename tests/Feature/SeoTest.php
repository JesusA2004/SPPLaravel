...
test('la página de inicio tiene título, descripción y metadatos sociales', function () {
    $this->get('/')
        ...
        ->assertSee('property="og:image" content="https://seguridadprivadaspp.com/images/marca/spp-social-2026-v2.jpg"', false)
...
test('si APP_URL quedó en localhost se usa el dominio real de la visita', function (string $requestUrl) {
    ...
    $response
        ...
        ->assertSee('property="og:image" content="https://seguridadprivadaspp.com/images/marca/spp-social-2026-v2.jpg"', false)
        ->assertSee('name="twitter:image" content="https://seguridadprivadaspp.com/images/marca/spp-social-2026-v2.jpg"', false)
